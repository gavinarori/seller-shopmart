...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen pb-20">
      <div>
        <div className={`h-48 w-full lg:h-64 ${gradients}`} />
      ...
      <div className="mt-6 ml-3 sm:flex-1 sm:min-w-0 sm:flex sm:items-center sm:space-x-6 sm:pb-1 text-sm tracking-wider leading-6">
        <div className="flex items-center">
          <h4 className="mr-1 mb-0 font-semibold text-white text-2md">Role</h4>{" "}
          <p className="text-gray-400">{userInfo?.role}</p>
        </div>
        <div className="flex items-center">
          <h4 className="mr-1 mb-0 font-semibold text-white text-2md">Status</h4>{" "}
